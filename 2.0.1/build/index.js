...
kg/textbox/2.0.0/text
kg/textbox/2.0.0/keyCodeUtils
kg/textbox/2.0.0/number
kg/textbox/2.0.0/numberUtils
kg/textbox/2.0.0/phonenumber
kg/textbox/2.0.0/qqnumber
kg/textbox/2.0.0/index
 ...
 * 2.aria支持
 */
KISSY.add('kg/textbox/2.0.0/text',function (S, DOM, Node, Base, JSON, Overlay) {
    var UA = S.UA;
 ...
 * @date 2013-01-22
 */
KISSY.add('kg/textbox/2.0.0/keyCodeUtils',function (S) {
    return {
        LEFT: 37,
        UP: 38,
        RIGHT: 39,
 ...
 * 2.aria支持
 */
KISSY.add('kg/textbox/2.0.0/number',function (S, DOM, Node, TextBox, KeyCodeUtils) {
        /*
         * @name NumberTextBox
         * @class 号码输入框
         * @extends TextBox
 ...
 * @date 2012-06
 */
KISSY.add('kg/textbox/2.0.0/numberUtils',function (S, AJAX) {
    var re = {};
 ...
 * @date 2013-01-22
 */
KISSY.add('kg/textbox/2.0.0/phonenumber',function (S, DOM, Node, NumberTextBox, NumberUtils) {
        /*
 ...
 * 2.aria支持
 */
KISSY.add('kg/textbox/2.0.0/qqnumber',function (S, DOM, Node, Base, NumberTextBox, KeyCodeUtils) {
        /*
 ...
 * @date 2013-01-22
 */
KISSY.add('kg/textbox/2.0.0/index',function (S, TextBox, NumberTextBox, PhoneNumberTextBox, QQNumberTextBox) {
        return {
            TextBox: TextBox,
