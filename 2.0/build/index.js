...
gallery/textbox/1.4/text
gallery/textbox/1.4/keyCodeUtils
gallery/textbox/1.4/number
gallery/textbox/1.4/numberUtils
gallery/textbox/1.4/phonenumber
gallery/textbox/1.4/qqnumber
gallery/textbox/1.4/index
 ...
 * 2.aria支持
 */
KISSY.add('gallery/textbox/1.4/text',function (S, DOM, Node, Base, JSON, Overlay) {
    var UA = S.UA;
 ...
 * @date 2013-01-22
 */
KISSY.add('gallery/textbox/1.4/keyCodeUtils',function (S) {
    return {
        LEFT: 37,
        UP: 38,
        RIGHT: 39,
 ...
 * 2.aria支持
 */
KISSY.add('gallery/textbox/1.4/number',function (S, DOM, Node, TextBox, KeyCodeUtils) {
        /*
         * @name NumberTextBox
         * @class 号码输入框
         * @extends TextBox
 ...
 * @date 2012-06
 */
KISSY.add('gallery/textbox/1.4/numberUtils',function (S, AJAX) {
    var re = {};
 ...
 * @date 2013-01-22
 */
KISSY.add('gallery/textbox/1.4/phonenumber',function (S, DOM, Node, NumberTextBox, NumberUtils) {
        /*
 ...
 * 2.aria支持
 */
KISSY.add('gallery/textbox/1.4/qqnumber',function (S, DOM, Node, Base, NumberTextBox, KeyCodeUtils) {
        /*
 ...
 * @date 2013-01-22
 */
KISSY.add('gallery/textbox/1.4/index',function (S, TextBox, NumberTextBox, PhoneNumberTextBox, QQNumberTextBox) {
        return {
            TextBox: TextBox,
